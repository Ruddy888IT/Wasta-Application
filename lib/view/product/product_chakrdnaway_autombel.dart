...
class product_chakaraway_autombel extends StatefulWidget {
   final AppBarName appbarname;
  product_chakaraway_autombel({super.key, required this.works, required this.appbarname});
  String works;

  
  @override
  _product_chakaraway_autombelState createState() => _product_chakaraway_autombelState();
}

class _product_chakaraway_autombelState extends State<product_chakaraway_autombel> {
