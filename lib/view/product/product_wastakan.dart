...
class product_wastakan extends StatefulWidget {
   final AppBarName appbarname;
  product_wastakan({super.key, required this.works, required this.appbarname});
  String works;

  
  @override
  _product_wastakanState createState() => _product_wastakanState();
}

class _product_wastakanState extends State<product_wastakan> {
