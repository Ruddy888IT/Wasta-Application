...
class product_bargdwr extends StatefulWidget {
   final AppBarName appbarname;
  product_bargdwr({super.key, required this.works, required this.appbarname});
  String works;

  
  @override
  _product_bargdwrState createState() => _product_bargdwrState();
}

class _product_bargdwrState extends State<product_bargdwr> {
