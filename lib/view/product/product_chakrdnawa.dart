...
class product_chakrdnawa extends StatefulWidget {
   final AppBarName appbarname;
  product_chakrdnawa({super.key, required this.works, required this.appbarname});
  String works;

  
  @override
  _product_chakrdnawaState createState() => _product_chakrdnawaState();
}

class _product_chakrdnawaState extends State<product_chakrdnawa> {
