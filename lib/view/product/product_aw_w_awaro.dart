...
class product_aw_w_awaro extends StatefulWidget {
   final AppBarName appbarname;
  product_aw_w_awaro({super.key, required this.works, required this.appbarname});
  String works;

  
  @override
  _product_aw_w_awaroState createState() => _product_aw_w_awaroState();
}

class _product_aw_w_awaroState extends State<product_aw_w_awaro> {
